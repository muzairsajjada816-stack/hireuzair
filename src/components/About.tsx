          ...
          <div>
            ...
            <div className="reveal reveal-delay-4 mt-6">
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20 glow-pulse hover:border-primary/40 transition-colors duration-300 group"
              >
